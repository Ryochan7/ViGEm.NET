...
{
    private static readonly List<Xbox360Button> ButtonMap = new()
    {
        Xbox360Button.Up,
        Xbox360Button.Down,
        Xbox360Button.Left,
    ...
    private static readonly List<Xbox360Axis> AxisMap = new()
    {
        Xbox360Axis.LeftThumbX, Xbox360Axis.LeftThumbY, Xbox360Axis.RightThumbX, Xbox360Axis.RightThumbY
    };

    private static readonly List<Xbox360Slider> SliderMap = new()
    {
